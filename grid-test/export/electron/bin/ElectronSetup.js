...
ElectronSetup.main = function() {
	...
	var windows = [{ allowHighDPI : false, alwaysOnTop : false, antialiasing : 0, background : 0, borderless : false, colorDepth : 32, depthBuffer : true, display : 0, fullscreen : false, hardware : true, height : 480, hidden : false, maximized : false, minimized : false, parameters : { }, resizable : false, stencilBuffer : true, title : "grid-test", vsync : false, width : 640, x : null, y : null}];
	var _g = 0;
	...
	while(_g < _g1) {
		...
		ElectronApp.on("ready",(function(frame,height,width,$window) {
			return function(e) {
				var config = { fullscreen : $window[0].fullscreen, frame : frame[0], resizable : $window[0].resizable, alwaysOnTop : $window[0].alwaysOnTop, width : width[0], height : height[0], webgl : $window[0].hardware};
