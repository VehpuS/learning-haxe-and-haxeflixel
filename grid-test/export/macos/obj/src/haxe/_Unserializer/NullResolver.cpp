...
HX_LOCAL_STACK_FRAME(_hx_pos_6789dee647201548_487_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","/usr/local/lib/haxe/std/haxe/Unserializer.hx",487,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_6789dee647201548_490_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",490,0x60de4a67)
namespace haxe{
...
::hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_487_resolveClass)
...
::hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_490_resolveEnum)
